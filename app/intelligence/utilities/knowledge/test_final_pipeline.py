...
def print_data_flow_analysis(
    ...
    # ================================================================
    # FIX: Get semantic entities from multiple sources
    # ================================================================
    ...
    if not semantic_entities:
        ...
        for interp in interpretations:
            ...
            if entities:
                semantic_entities.extend(entities)
    
    # If still no semantic_entities, try the old way
    if not semantic_entities:
    ...
    # ================================================================
    # Get relations from multiple sources
    # ================================================================
    ...
    print(
        ...
        "  → Dependencies"
        f"     {len(dependencies):>5}"
    )

    print(
        f"  Dependencies       {len(dependencies):>5}"
        "  → Statements"
        f"       {len(statements):>5}"
    )
